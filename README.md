...
- **Memory & performance**: Lazy WebViews. Inactive tabs sleep after a configurable interval (0–120 minutes). Suspended pages preserve their live DOM state. Visible, loading, audible, and downloading pages are protected from sleeping.
...
- **Session restore**: Restores the last navigated URL, not deep backward/forward history stacks, unsaved form contents, or scroll positions. Live tab switching and background suspension preserve complete DOM and execution state.
